...
![TIM1 定时器基本参数配置](img/4TIM1.png)

### 3.6 配置互补 PWM 输出通道（CH2 + CH2N）
...
![互补 PWM 通道配置](img/5PWMGenerationChannel2and2N.png)
...
![死区时间与刹车配置](img/6Break.png)

### 3.8 配置 BKIN 刹车输入引脚（GPIO）
